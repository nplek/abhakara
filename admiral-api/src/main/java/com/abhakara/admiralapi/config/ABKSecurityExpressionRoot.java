...
public class ABKSecurityExpressionRoot implements MethodSecurityExpressionOperations {
    ...
    public ABKSecurityExpressionRoot(Authentication authentication) {
    ...
    public boolean isMember(Long OrganizationId) {
        final ABKUser user = ((ABKUserPrincipal) this.getPrincipal()).getUser();
